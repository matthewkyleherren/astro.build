...
<p class="box" class="rounded-lg bg-termitidae-gray-500 p-8" set:html={solidLogo}></p>
<style
	is:inline
...
<p class="box" class="rounded-lg bg-termitidae-gray-500 p-8 text-termitidae-gray-100" set:html={litLogo}></p>
